...
QUESTION_PATTERNS = ({'id': 'flush',
 ...
 {'id': 'preflop_equity',
  ...
  'answer_type': 'percent',
  'stages': ['preflop'],
  'levels_by_players': {6: 'beginner', 9: 'intermediate'},
  'level_rule': 'players',
  'players': [6, 9],
  'per_player': 169},
 {'id': 'postflop_equity',
 ...
 {'id': 'opponent_rank',
  ...
  'stage_counts': {'preflop': 153, 'flop': 249, 'turn': 249}},
...
MODE_COUNTS = {'A': 10000, 'B': 4800, 'C': 1200, 'D': 4500}

LEGACY_MODE_COUNTS = {'A': 6000, 'B': 3000, 'C': 338, 'D': 651}

GROUP_COUNTS = {'A': 10000, 'BC': 6000, 'D': 4500}
...
NEW_D_COUNTS = {'opponent_pocket_pair': 205,
 'opponent_overpair': 205,
 'opponent_set': 205,
 'opponent_top_pair_plus': 205,
 'opponent_two_pair': 205,
...
B_HAND_COMPARISON_STAGE_TARGETS = {'preflop': {'pair_vs_overcards': 600, 'playable_preflop': 600},
 'flop': {'draw_vs_two_pair_plus': 150,
          'top_pair_vs_flush_draw': 200,
          'one_pair_kicker': 100,
          'combo_hand': 150,
          'continue_matchup': 300},
 'turn': {'draw_vs_two_pair_plus': 150,
          'top_pair_vs_flush_draw': 200,
          'one_pair_kicker': 100,
          'combo_hand': 150,
          'continue_matchup': 300}}

B_BEGINNER_ARCHETYPES = ('one_pair_kicker', 'pair_vs_overcards', 'top_pair_vs_flush_draw')

C_POSTFLOP_PER_PLAYER = 431

D_OPPONENT_RANK_STAGE_COUNTS = {'preflop': 153, 'flop': 249, 'turn': 249}
